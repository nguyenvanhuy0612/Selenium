...
public class NewAccount {
	...
	public static void main(String[] args) {
		...
		WebElement	verifyPasswordElement = driver.findElement(By.cssSelector("input[type='password'][name='ctl00$MainContent$txtVerifyPassword']"));
		...
		WebElement	occassionalUpdate = driver.findElement(By.id("MainContent_checkUpdates"));
        ...
        //occassionalEmail
        if (occassionalEmail) {
        	if (!occassionalUpdate.isSelected()) {
        		occassionalUpdate.click();
        	}
        }else {
        	if (occassionalUpdate.isSelected()) {
        		occassionalUpdate.click();
 ...
 * driver.findElement(By.xpath("//*[@id=\"MainContent_menuCountry\"]/option[8]")).click();
 * 
 * 
 */
